...
/* Updater.html.twig */
class __TwigTemplate_a34972243c909f418256f129e75dea9dae294cc43694d4d2b018b5512554064d extends \Twig\Template
{
    private $source;
    private $macros = [];
...
$context["item"], "stable", [], "any", false, false, false, 78)) {
    ...
    <div class=\"modal fade\" id=\"modalTelemetry\" tabindex=\"-1\" role=\"dialog\" aria-hidden=\"true\">
        ...
        if (twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["fsc"] ?? null), "telemetryManager", [], "any", false, false, false, 100), "ready", [], "method", false, false, false, 100)) {
            ...
            // line 109
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["fsc"] ?? null), "url", [], "method", false, false, false, 109), "html", null, true);
            echo "?action=claim-install\" target=\"_blank\">
                            ";
            // line 110
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["i18n"] ?? null), "trans", [0 => "manage"], "method", false, false, false, 110), "html", null, true);
            echo "
                        </a>
                    </div>
                ";
            ...
            // line 114
            echo "                    <form action=\"";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["fsc"] ?? null), "url", [], "method", false, false, false, 114), "html", null, true);
            echo "\" method=\"post\">
                        <input type=\"hidden\" name=\"action\" value=\"register\" />
                        <div class=\"modal-header\">
                            <h5 class=\"modal-title\">";
            // line 117
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["i18n"] ?? null), "trans", [0 => "register-installation"], "method", false, false, false, 117), "html", null, true);
            echo "</h5>
                            <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"";
            // line 118
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["i18n"] ?? null), "trans", [0 => "close"], "method", false, false, false, 118), "html", null, true);
            echo "\">
                                <span aria-hidden=\"true\">&times;</span>
                            </button>
                        </div>
                        <div class=\"modal-body\">
                            <p>";
            // line 123
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["i18n"] ?? null), "trans", [0 => "register-installation-p"], "method", false, false, false, 123), "html", null, true);
            echo "</p>
                            <button type=\"submit\" class=\"btn btn-primary\">
                                ";
            // line 125
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["i18n"] ?? null), "trans", [0 => "register-installation"], "method", false, false, false, 125), "html", null, true);
            echo "
                            </button>
                        </div>
                    </form>
